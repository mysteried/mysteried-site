export const STAGE = {
    ...
    chat: {
        ...
        script: [
            { who: "hina", face: "normal", text: "さあ、マスオさん、やりますよ！" },
            { who: "masu", face: "normal", text: "……どっちのパターンだい？ まさか現地に——" },
            { who: "hina", face: "normal", text: "現地で謎解きです！\nまあ、行くか行かないかは置いておいて、とにかく一旦やってみましょうよ！" },
            { who: "masu", face: "normal", text: "そうだね……\nじゃあメモを見せてくれるかい？" },

            // 1枚目のメモ
            { type: "note" },

            { who: "hina", face: "normal", text: "日本海側の街ですね" },
            { who: "masu", face: "normal", text: "遠いなぁ……\n聞いただけで寒くなってきたよ" },
            { who: "hina", face: "normal", text: "ヒントは少ないようで、意外と絞れそうです" },
            { who: "masu", face: "normal", text: "そうだね。\n温泉街の記憶は一旦置いておいて…" },
            { who: "hina", face: "normal", text: "港、神宮、倉庫、松。\nこの4つがキーワードですね" },
            { who: "masu", face: "normal", text: "倉庫と港は、正直あまり差別化にはならないかな。\nありふれているしね" },
            { who: "hina", face: "normal", text: "はい。\nなので「神宮」と「松」に注目してみます" },
            { who: "masu", face: "normal", text: "うん、ヒナタくん……\n探偵スキル、上がってきたんじゃない？" },
            { who: "hina", face: "normal", text: "えへへ。\nじゃあ、この条件で検索してみますね…" },
            ...
            { who: "hina", face: "normal", text: "約330kmです！" },
            { who: "masu", face: "normal", text: "……" },
            { who: "hina", face: "normal", text: "3連休あたりに行ってみましょう！" },
            { who: "masu", face: "normal", text: "いや、だから「行くか行かないかは置いておいて」って言ったよね？" },
