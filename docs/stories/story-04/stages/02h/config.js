export const STAGE = {
    ...
    intro: {
        onceKey: "prologue:story04:02",
        skippable: true,
        steps: [
            { type: "text", key: "text1", text: "『茎と魚は何故消えたのか？』\nクリア！", dur: 3000 },
    ...
    chat: {
        ...
        script: [
            ...
            { who: "masu", face: "smile", text: "やっぱり自宅でサクッとできる方がいいね" },
            { who: "hina", face: "excited", text: "次はまた現地に行きたいです" },
            { who: "masu", face: "sweat", text: "おいおい…" },
            { who: "hina", face: "thinking", text: "北海道とか沖縄とか、どうしょう？" },
