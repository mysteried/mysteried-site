...
export const STAGE = {
    ...
    // nextUrl: "../02/stage.html?intro=1",🔥本番では削除する
    nextUrlEncoded: "Li4vMDIvc3RhZ2UuaHRtbD9pbnRybz0x",  // Base64 of "../02/stage.html?intro=1"
    ...
    intro: {
        onceKey: "prologue:story01:01", // 一度だけ再生したいなら有効化（無効化すると戻るでも再生される）
        skippable: true,
        steps: [
